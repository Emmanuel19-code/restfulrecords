...
const Payment = () => {
  ...
  const handlePayment = async (event) => {
    ...
    if (!deliveryMethod) {
      setError("Please select how you want to receive the death certificate.");
      setPaymentStatus(null);
      return;
    }
    ...
    try {
      ...
      if (response.success) {
        setPaymentStatus(
          "Payment Successful! You will receive a receipt via mail."
        );
      ...
      <form onSubmit={handlePayment} className="space-y-4">
        ...
        {paymentMethod === "mobile" && (
          <>
            ...
            <select className="w-full p-2 border rounded">
              ...
              <option value="vodacash">Voda Cash</option>
        ...
        <div>
          <label className="block font-medium mb-1">
            How would you like to receive the death certificate?
          </label>
          <select
            className="w-full p-2 border rounded"
